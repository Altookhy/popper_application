...
% Grab action examples - valid cases
...
pos(valid_grab_action(o4, [robot(1,1), holding(none), object_pos(o4,1,1)])).

% Grab action examples - invalid cases
...
% Release action examples - valid cases
...
pos(valid_release_action(o4, [robot(1,1), holding(yellow), goal_pos(yellow,1,1)])).

% Release action examples - invalid cases
